    ...
    },
    {
        ...
        options: [
            ...
            },
            {
                value: 'B',
                label: "AI B (브랜드 빌더형)",
                text: "반짝 유입보다는 구매할 '진성 고객'을 모아야 돈이 됩니다.  검색 최적화(SEO)부터 상세페이지 설득 논리까지, 6개월 뒤에도 매출이 나오는 '시스템'을 구축합시다."
            }
        ]
    },
    {
        ...
        options: [
            {
                value: 'A',
                label: "AI A (주도적 리더형)",
                text: "저한테 맡기세요.  오늘부터 2주간 실행할 '매출 증대 긴급 액션 플랜'을 짰습니다. 1번부터 5번까지 순서대로 실행만 하세요. 준비되셨나요?"
            },
            {
                value: 'B',
                label: "AI B (지원적 참모형)",
